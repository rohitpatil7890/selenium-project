...
public class LimitTransferToIAPom2 {
...
//	
//	@FindBy(name = "ctl00$body$txtHeadtype")
//	public WebElement SchemeCode;
//	
//	@FindBy(xpath = "//span[@id='body_Label10']")
//	public WebElement ClickSIDE;
//	
//	@FindBy(xpath = "//*[@id=\"body_grdHeadType_btnHeadCode_0\"]")
//	public WebElement Clickschemecode;
//	
//	@FindBy(xpath = "//input[@id='body_txtSearchIA']")
//	public WebElement ClickSearchIA;
//    
//	@FindBy(xpath = "//*[@id=\"body_Label10\"]")
//	public WebElement ClickSIDE1;
//	
//	@FindBy(xpath = "	//input[@id='body_txtExpAmtYr3']")        
//	public WebElement FundTransferAmount;
//	
//	@FindBy(id = "body_grdRemmiBlock_txtTotAmount_0")  
//	public WebElement FundAmount;
//	
//	
	...
	@FindBy(xpath = "//input[@id='body_btnOkDisplayModalFile']")
	...
	////////////////////CNA MAKER LIMIT APPROVAL INBOX/////////////////////////////////
	...
	////////////////////////CNA MAKER LIMIT APPROVAL OUTBOX///////////////////////////////////
...
////////////////////////CNA CHECKER LIMIT APPROVAL INBOX/////////////////////////////////////	
	...
	////////////////////CNA CHECKER LIMIT APPROVAL OUTBOX//////////////////////////////////////////////
	...
	public LimitTransferToIAPom2(WebDriver driver)
...
//		Thread.sleep(2000);
	...
	public void ClickOnLimitAllocated(String Amount) throws InterruptedException {
...
//	public void clickonSelectBudgetYear() throws InterruptedException {
//		BudgetYear.click();
//		Thread.sleep(1000);
//		Select s1 = new Select(BudgetYear);
//		s1.selectByVisibleText("2022-23");
//		Thread.sleep(1000);
//		BudgetYear.sendKeys(Keys.TAB);
//		Thread.sleep(1000);
//	}
//	public void SchemeCode1(String Code) throws InterruptedException {
//		String scCode = Code.replaceAll("^\"|\"$", "");
//		SchemeCode.sendKeys(scCode);
//		Thread.sleep(2000);
//		SchemeCode.sendKeys(Keys.TAB);
//		Thread.sleep(2000);
//		
//	}
...
//		Clickschemecode.click();
//		Thread.sleep(1000);
//	}
//	public void SearchIA(String IA) throws InterruptedException {
//		ClickSearchIA.sendKeys(IA);
//		Thread.sleep(1000);
//	}
//	public void clickonSide1() throws InterruptedException {
//		ClickSIDE1.click();
//		Thread.sleep(1000);
//	}
//	public void FundTransfer(String Fund1) throws InterruptedException {
//		String scFundAmt = Fund1.replaceAll("^\"|\"$", "");
//		FundTransferAmount.sendKeys(scFundAmt);
//		FundTransferAmount.sendKeys(Keys.TAB);
//		Thread.sleep(2000);
//	}
//
//	
//	public void EnterBudget(String Fund2) throws InterruptedException {
//		String scFundAmt2 = Fund2.replaceAll("^\"|\"$", "");
//		FundAmount.sendKeys(scFundAmt2);
//		FundAmount.sendKeys(Keys.TAB);
//		Thread.sleep(2000);
