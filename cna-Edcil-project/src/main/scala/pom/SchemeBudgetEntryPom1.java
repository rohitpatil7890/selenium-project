...
public class SchemeBudgetEntryPom1 {
	...
	@FindBy(xpath = "//*[@id=\"body_txtSactionedOrderNo\"]") 
	public WebElement SanctionedOrderNumber;

	@FindBy(xpath = "//*[@id=\"FileUploadGRCopy\"]") 
	...
	@FindBy(name = "ctl00$body$btnRedirect")
	...
	@FindBy(name = "ctl00$body$btnYes")
	public WebElement ApproveSlipYes;

	@FindBy(name = "ctl00$body$BtnOk")
	...
	@FindBy(xpath = "//*[@id=\"tblSchemeBudgetOutBox\"]/tbody/tr[1]/td[1]/a/div")
	...
	public SchemeBudgetEntryPom1(WebDriver driver)
	...
	public void clickBudgetAmount(String strBudgetAmmount, WebDriver driver) throws InterruptedException {
		BudgetAmount.sendKeys(strBudgetAmmount);
		BudgetAmount.sendKeys(Keys.TAB);
		Thread.sleep(2000);
		strBudgetAmmount = handleBoundaryValue(strBudgetAmmount, driver);
...
//		OrderCopy.sendKeys(file);
//		Thread.sleep(1000);
		public void clickonOrderCopy() throws InterruptedException {
			OrderCopy.sendKeys("E:\\pdf file\\demo.pdf");
			Thread.sleep(1000);
...
//	clickonSchemeBudgetApproval1
	...
	//*[@id="Form1"]/div[4]/div[3]/div/div/ul/li[2]/ul/li[3]/a
	...
	public String handleBoundaryValue(String budgetAmount, WebDriver driver) {

		Long logBudgAmt = Long.parseLong(budgetAmount);
		Long maxLimit = 5000000000L;
		Boolean amtZero= false;
		Boolean isPopUpdisplay= false;
		if (logBudgAmt <= 0 ) {
			isPopUpdisplay = true;
		}
		if (logBudgAmt > maxLimit) {
			amtZero = true;
		}

		if (isPopUpdisplay || amtZero) {

			/*
			 * WebElement clickOutside =
			 * driver.findElement(By.xpath("//*[@id=\"body_txtSactionedOrderNo\"]"));
			 * clickOutside.click();
			 */

			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			// wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"body_txtSactionedOrderNo\"]"))).click();
			WebElement alertBoxOk = driver.findElement(By.id("body_btnRedirect")); //*[@id="body_btnRedirect"]
			alertBoxOk.click();

			JavascriptExecutor jse = (JavascriptExecutor) driver;
			jse.executeScript("document.getElementById('body_txtNewSchemeAmount').focus();");
