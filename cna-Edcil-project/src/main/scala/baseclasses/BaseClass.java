...
public class BaseClass{
	...
	public void initializeBrowser() throws IOException {
		...
		driver.get("http://192.168.0.162:8018/Login.aspx");
		driver.manage().window().maximize();
		// driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS);
		
//		"E:\XlFile\LOGIN_CREDENTIAL_Comman.xlsx"
	}
...
//  driver.get("http://192.168.0.162:5259/Login.aspx");
//  driver.manage().window().maximize();
//	}
	
	//http://192.168.0.162:5259/DeductionApproval.aspx
