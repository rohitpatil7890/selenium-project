...
import pom.DeductionAcountMappingWorkPom;

public class DeductionAcountMappingWorkTest extends BaseClass {

	DeductionAcountMappingWorkPom login;
	...
	{
		initializeBrowser();
		login = new DeductionAcountMappingWorkPom(driver);

	}

	@Test(priority = 0)
	public void HoldingAccountMapping() throws EncryptedDocumentException, IOException, InterruptedException
	{
//		try {
			...
			String expectedUrl = "http://192.168.0.162:8018/DeductiondeclartaionMuttiplereportSlip.aspx";
			...
			@Test(priority = 1,dependsOnMethods= {"HoldingAccountMapping"})
			public void HoldingAccountMappingApproveByIAMaker()throws EncryptedDocumentException, IOException, InterruptedException {
...
//			s.IamakerlogoutYes()
			...
			@Test(priority = 2,dependsOnMethods= {"HoldingAccountMappingApproveByIAMaker"})
...
//			}
			...
			//////////////////////IA APPROVER/////////////////////
			@Test(priority = 3,dependsOnMethods = {"holdAccountMappingApproveByIAChecker"})
