...
public class WorkCreation1Test extends BaseClass {
...

	{
			...
			login.ClickOnSaveYesok();
			 String expectedUrl = "http://192.168.0.162:8018/WORKDETAILS.ASPX";    
	...
	@Test(priority = 2,dependsOnMethods = {"projectApprovalByIAMaker"})
...
//			login.clickOnViewSlip2();
	...
	@Test(priority = 3,dependsOnMethods = {"projectApprovalByIAChecker"})
	public void IaApprover() throws Exception{
