...
import pom.HoldingAccountMappingContPom;

public class HoldingAccountMappingContTest extends BaseClass {

	HoldingAccountMappingContPom login;
	...
	{
		initializeBrowser();
		login = new HoldingAccountMappingContPom(driver);

	}

	@Test(priority = 0)
	public void createHoldAccountMappingForCont() throws EncryptedDocumentException, IOException, InterruptedException {
	...
	@Test(priority = 1, dependsOnMethods= {"createHoldAccountMappingForCont"})
