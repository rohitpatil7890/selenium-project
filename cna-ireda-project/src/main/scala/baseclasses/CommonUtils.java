...

{
	...
	// @Author Name
	    ...
	    {
	        FileInputStream file = new FileInputStream("E:\\XLFile\\cna-ireda\\LOGIN_CREDENTIAL.xlsx");
...
//	
	...
	public static void writeExcel(int rowNum, int cellNum, String inputString) throws  IOException 
    {
