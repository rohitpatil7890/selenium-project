...
import CNA.cna_ireda_project.reader.mycomponent.MyStreamReaderImpl
import CNA.cna_ireda_project.transformer.mycomponent.MyStreamTransformerImpl
import CNA.cna_ireda_project.writer.mycomponent.MyStreamWriterImpl
