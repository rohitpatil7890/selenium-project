...
public class IAMAdministrativeApprovalCreationPom {
	...
	public WebElement OutBoxSearchBox;
...
//	public void AAamountenter(String ammount) throws InterruptedException {
...
//	}
	...
	public void successclick() {
		//String text = driver.findElement(By.xpath("//*[@id=\"body_lblMsgFromServer\"]/span[2]")).getText();
		//mapAANumber.put("aaNumberFromMap", text);
		success.click();
	...
	public void hoverAAfileapprovel(WebDriver driver) throws InterruptedException {
		Actions action = new Actions(driver);
		action.moveToElement(AAfileapproval).perform();
		Thread.sleep(2000);
	}
	
	public void hoverAAfileapprovel1(WebDriver driver) throws InterruptedException {
		Actions action = new Actions(driver);
	...
	public void searchAANumber(Map<String, String> mapAANumber) throws InterruptedException {
		InboxsearchBox.sendKeys(mapAANumber.get("aaNumber"));
		Thread.sleep(2000);
		InboxsearchBox.sendKeys(Keys.ENTER);
		Thread.sleep(2000);
	}

	public void inboxslipview() throws InterruptedException {
		inboxslip.click();
		Thread.sleep(2000);
	}
	...
	public void searchAANumber1(Map<String, String> mapAANumber) throws InterruptedException {
		OutBoxSearchBox.sendKeys(mapAANumber.get("aaNumber"));
		Thread.sleep(2000);
		OutBoxSearchBox.sendKeys(Keys.ENTER);
		Thread.sleep(2000);
	}
