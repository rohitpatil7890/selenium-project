...
public class Iamakerbillgenration {
 ...
 @FindBy(xpath = "//*[@id=\"txtUser\"]")
	...
	@FindBy(xpath = "//a[normalize-space()='Transaction']")  //a[normalize-space()='Transaction']
	public WebElement transaction;
	
	//*[@id=\"Form1\"]/div[4]/div[3]/div/div/ul/li[1]/a
	...
	@FindBy(xpath ="//select[@id='body_ddlHeadCode']") //select[@id='body_ddlHeadCode']//*[@id="body_ddlHeadCode"]
   ...
   // public WebElement inboxslip;
	...
	@FindBy(xpath ="//th[@aria-label='Status: activate to sort column ascending']")  //th[@aria-label='Status: activate to sort column ascending']
...
//	public WebElement Billtransaction;
	...
	@FindBy(xpath ="//input[@id='btnLogout']") //input[@id='btnLogout']  //input[@id='btnLogout']
	...
	//*[@id="btnYesLogout"]
	 ...
	 @FindBy(xpath = "//a[normalize-space()='Transaction']")  //*[@id="Form1"]/div[4]/div[3]/div/div/ul/li[1]/a
	 public WebElement IACtransaction1;
	 
	//a[normalize-space()='Transaction']  //a[normalize-space()='Transaction']

	 @FindBy(xpath = "//a[normalize-space()='Bill Transactions']") //*[@id=\"Form1\"]/div[4]/div[3]/div/div/ul/li[1]/ul/li[1]/a
	 public WebElement BillTransection1;

	//a[normalize-space()='Bill Transactions']
	 @FindBy(xpath = "//a[normalize-space()='Bill Outwards']")
	...
	public Iamakerbillgenration(WebDriver driver)
	...
	public void enterbillAmount(String billamt,WebDriver driver, Boolean isvalidAmt) throws InterruptedException {
