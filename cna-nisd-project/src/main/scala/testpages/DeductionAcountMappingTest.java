...
public class DeductionAcountMappingTest extends BaseClass {
	...
	@Test(priority = 0)
	public void createHoldAccountMapping() throws EncryptedDocumentException, IOException, InterruptedException {
			...
			String expectedUrl = "http://192.168.0.162:5259/DeductiondeclartaionMuttiplereportSlip.aspx";
	...
	@Test(priority=1, dependsOnMethods = {"createHoldAccountMapping"})
