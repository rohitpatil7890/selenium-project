...
public class LimitTransferToIATest1 extends BaseClass {
	...
	@Test(priority=0)
	public void saveLimitTransferToIA() throws Exception {
		/////////////// CNA MAKER////////////////////////////////////////
			...
			String expectedUrl = "http://192.168.0.162:3364/DmaBudgetTransfer.aspx";
	...
	@Test(priority = 1, dependsOnMethods= {"saveLimitTransferToIA"})
