...
public class WorkCreationHeadCode2 {
	  @FindBy(xpath = "//*[@id=\"txtUser\"]")
	    ...
	    @FindBy(xpath = "//*[@id=\"body_grdHeadType_btnHeadCode_2\"]")
		...
		public WorkCreationHeadCode2(WebDriver driver)
		...
		public void clickOnTransaction() throws InterruptedException {
			...
			public void EnterTendorAmount(String TendorAmount1) throws InterruptedException {
				TendorAmount.sendKeys(TendorAmount1);
			...
			public void clickonOrderCopy(WebDriver driver) throws InterruptedException, AWTException {  
//				  WorkOrderCopy.sendKeys(""); 
//				  Thread.sleep(3000);
				 
				  WebElement chooseFile = driver.findElement(By.cssSelector("#FileUpload"));
				  chooseFile.sendKeys("E:\\demofile.pdf");
